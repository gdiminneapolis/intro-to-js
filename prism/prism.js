...
(function(){
    ...
    //    {
    //        var pre_classes = pre.className;
    //
    //        var linkCopy = document.createElement('a');
    //        linkCopy.innerHTML = 'Copy Code';
    //        linkCopy.className = 'ugly_link';
    //
    ...
    //            pre.setAttribute('class', pre_classes + ' hovering_toolbar');
    //        });
    //        clip.on('mouseout', function (c,a) {
    //            pre.setAttribute('class', pre_classes);
    //        });
    ...
    //    if(pre.getElementsByClassName("toolbar").length <= 0) {
    //        var copy_code_wrapper = document.createElement('div');
    //        copy_code_wrapper.innerHTML = 'Copy Code';
    //        copy_code_wrapper.className = 'copy_code_wrapper';
    //        pre.appendChild(copy_code_wrapper);
    ...
    function highlightLines(pre, lines, classes) {
        ...
        var lineHeight = parseFloat(getComputedStyle(pre).lineHeight) + 12;
